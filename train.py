...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp6/weights/best.pt', help='initial weights path') # 模型训练权重
    parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='model.yaml path') # 模型配置信息
    parser.add_argument('--data', type=str, default='data/herodataset.yaml', help='data.yaml path') # 数据集配置信息
